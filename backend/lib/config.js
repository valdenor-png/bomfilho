...
const RECAPTCHA_KEY_DISPONIVEL = Boolean(RECAPTCHA_SECRET_KEY) || RECAPTCHA_ENTERPRISE_MODE;
const RECAPTCHA_CHECKOUT_PROTECTION_ENABLED = RECAPTCHA_CHECKOUT_ENABLED && RECAPTCHA_KEY_DISPONIVEL;
const RECAPTCHA_PAYMENT_PROTECTION_ENABLED = RECAPTCHA_PAYMENT_ENABLED && RECAPTCHA_KEY_DISPONIVEL;
const RECAPTCHA_AUTH_PROTECTION_ENABLED = RECAPTCHA_AUTH_ENABLED && RECAPTCHA_KEY_DISPONIVEL;

if ((RECAPTCHA_CHECKOUT_ENABLED || RECAPTCHA_PAYMENT_ENABLED) && !RECAPTCHA_KEY_DISPONIVEL) {
  const avisoRecaptcha = 'RECAPTCHA_CHECKOUT_ENABLED/RECAPTCHA_PAYMENT_ENABLED ativos sem chave reCAPTCHA. A protecao antiabuso do checkout ficara desabilitada.';
  if (IS_PRODUCTION) throw new Error(avisoRecaptcha);
  console.warn(`⚠️ ${avisoRecaptcha}`);
}

if (RECAPTCHA_AUTH_ENABLED && !RECAPTCHA_KEY_DISPONIVEL) {
  const avisoRecaptchaAuth = 'RECAPTCHA_AUTH_ENABLED ativo sem chave reCAPTCHA. A protecao antiabuso do login ficara desabilitada.';
...
module.exports = {
  ...
  RECAPTCHA_KEY_DISPONIVEL, RECAPTCHA_CHECKOUT_PROTECTION_ENABLED, RECAPTCHA_PAYMENT_PROTECTION_ENABLED, RECAPTCHA_AUTH_PROTECTION_ENABLED,

    ...
    try {
      ...
      const [rows] = await pool.query(
        `SELECT p.id,
                ...
                ${selectOptional(columns, 'frete_real_uber', 'frete_real_uber')},
                ${selectOptional(columns, 'margem_pedido', 'margem_pedido')},
                ${selectOptional(columns, 'mp_payment_id_mp', 'mp_payment_id_mp')},
                ${selectOptional(columns, 'mp_external_reference', 'mp_external_reference')},
                ${selectOptional(columns, 'mp_status', 'mp_status')},
                ${selectOptional(columns, 'mp_status_detail', 'mp_status_detail')},
                ${selectOptional(columns, 'mp_payment_status_internal', 'mp_payment_status_internal')},
                ${selectOptional(columns, 'mp_data_criacao_pagamento', 'mp_data_criacao_pagamento')},
                ${selectOptional(columns, 'mp_data_aprovacao_pagamento', 'mp_data_aprovacao_pagamento')},
                ${selectOptional(columns, 'mp_last_webhook_at', 'mp_last_webhook_at')},
                ${selectOptional(columns, 'mp_last_reconciled_at', 'mp_last_reconciled_at')},
                ${selectOptional(columns, 'pix_status', 'pix_status')},
                ${selectOptional(columns, 'pix_codigo', 'pix_codigo')},
                ${selectOptional(columns, 'pix_qrcode', 'pix_qrcode')},
                ${selectOptional(columns, 'pix_qr_base64', 'pix_qr_base64')},

...
> Nota (28/02/2026): este arquivo é histórico (ordem de criação). A estrutura operacional atual para desenvolvimento/deploy é: `frontend-react/` (frontend principal), `backend/` (API) e `legacy/` (HTML/CSS/JS antigo).
